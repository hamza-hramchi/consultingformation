          ...
          <div class="container">
            ...
            <div class="row mt-5 justify-content-center" data-aos="fade-up">
              <div class="section-title" data-aos="fade-up">
                ...
                <p>Dans le cadre de l'amélioration et de l'amélioration de la relation et de la communication avec ses clients, 
                ...
                <button type="button" class="btn btn-outline-dark btn-lg" data-toggle="modal" data-target="#AppointmentModal">
                  <i class="bx bx-calendar"></i> Prendre un rendez-vous
                </button>
              </div>
